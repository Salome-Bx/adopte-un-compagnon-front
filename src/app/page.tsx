...
import toast from 'react-hot-toast';
  ...
  const Home = () => {
    ...
    <main className="quicksand flex min-h-screen flex-col bg-custom-cream w-full">
      ...
      <div className="pets-meet flex py-10 pl-28 flex-col bg-white">
          <h3 className="text-custom-purple flex text-3xl w-full font-bold mb-12">Et si on se rencontrait ?</h3>
            ...
            {isLoading && (
                ...
                {petList && 
                    petList.slice(0, 3).map((pet: CardPetProps) => (
                        <div className="card flex flex-col max-sm:full sm:1/2 md:w-1/3 lg:w-1/4 h-[550px] cursor-pointer">
                            <label key={pet.id}>
            ...
            {isLoading && (
                ...
                {sosList && 
                        sosList.slice(0, 3).map((pet : CardPetProps) => (
                                ...
                                <div className="card flex bg-custom-white flex-col max-sm:full sm:1/2 md:w-1/3 lg:w-1/4 h-[550px] cursor-pointer">
                                    <label
                                    key={pet.id}   
                                    >
                                    <h4 className="name flex text-2xl font-bold text-custom-purple py-2">{pet.name}</h4>
